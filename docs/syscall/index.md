...
This package contains an interface to the low-level operating system primitives. The details vary depending on the underlying system, and by default, godoc will display the syscall documentation for the current system. If you want godoc to display syscall documentation for another system, set $GOOS and $GOARCH to the desired system. For example, if you want to view documentation for freebsd/arm on linux/amd64, set $GOOS to freebsd and $GOARCH to arm. The primary use of syscall is inside other packages that provide a more portable interface to the system, such as "os", "time" and "net". Use those packages rather than this one if you can. For details of the functions and data types in this package consult the manuals for the appropriate operating system. These calls return err == nil to indicate success; otherwise err is an operating system error describing the failure. On most systems, that error has type syscall.Errno.
...
- [asan0.go](/code/syscall/asan0)
- [dirent.go](/code/syscall/dirent)
- [endian_little.go](/code/syscall/endian_little)
- [env_unix.go](/code/syscall/env_unix)
- [exec_linux.go](/code/syscall/exec_linux)
- [exec_unix.go](/code/syscall/exec_unix)
- [flock.go](/code/syscall/flock)
- [lsf_linux.go](/code/syscall/lsf_linux)
- [msan0.go](/code/syscall/msan0)
- [net.go](/code/syscall/net)
- [netlink_linux.go](/code/syscall/netlink_linux)
- [setuidgid_linux.go](/code/syscall/setuidgid_linux)
- [sock_cloexec_linux.go](/code/syscall/sock_cloexec_linux)
- [sockcmsg_linux.go](/code/syscall/sockcmsg_linux)
- [sockcmsg_unix.go](/code/syscall/sockcmsg_unix)
- [sockcmsg_unix_other.go](/code/syscall/sockcmsg_unix_other)
- [syscall.go](/code/syscall/)
- [syscall_linux.go](/code/syscall/syscall_linux)
- [syscall_linux_accept4.go](/code/syscall/syscall_linux_accept4)
- [syscall_linux_amd64.go](/code/syscall/syscall_linux_amd64)
- [syscall_unix.go](/code/syscall/syscall_unix)
- [time_nofake.go](/code/syscall/time_nofake)
- [timestruct.go](/code/syscall/timestruct)
- [zerrors_linux_amd64.go](/code/syscall/zerrors_linux_amd64)
- [zsyscall_linux_amd64.go](/code/syscall/zsyscall_linux_amd64)
- [zsysnum_linux_amd64.go](/code/syscall/zsysnum_linux_amd64)
- [ztypes_linux_amd64.go](/code/syscall/ztypes_linux_amd64)
