...
This package contains runtime support for code generated by the cgo tool. See the documentation for the cgo command for details on using cgo.
...
- [callbacks.go](/code/runtime/cgo/callbacks)
- [callbacks_traceback.go](/code/runtime/cgo/callbacks_traceback)
- [cgo.go](/code/runtime/cgo/)
- [handle.go](/code/runtime/cgo/handle)
- [iscgo.go](/code/runtime/cgo/iscgo)
- [linux.go](/code/runtime/cgo/linux)
- [mmap.go](/code/runtime/cgo/mmap)
- [setenv.go](/code/runtime/cgo/setenv)
- [sigaction.go](/code/runtime/cgo/sigaction)
